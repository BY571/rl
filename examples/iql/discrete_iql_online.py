...
"""Discrete IQL Example.

This is a simple self-contained example of a discrete IQL training script.
...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    # Create logger
    exp_name = generate_exp_name("DiscreteIQL", cfg.env.exp_name)
    logger = None
    if cfg.logger.backend:
        logger = get_logger(
            logger_type=cfg.logger.backend,
            logger_name="diql_logging",
    ...
    # Create agent
    model, exploration_policy = make_discrete_iql_agent(
        cfg, train_env, eval_env, device
    )

    # Create discrete IQL loss
